...
const { loadOrCreateIdentity }              = require('./archipel-h24/src/crypto/identity');
const { createHello, createHelloReply,
        computeSessionKey, createAuth,
        verifyAuth }                         = require('./archipel-h24/src/crypto/handshake');
const { registerSession,
        sendMessage, receiveMessage }        = require('./archipel-h24/src/crypto/messenger');
const { trustOrVerify }                     = require('./archipel-h24/src/crypto/trust');
